...
def test_notify():
    ...
    """
    # test every template
    assert notify('me', 'ephetteplace@cca.edu', ['ANIMA-1000-1 Animation 1'], None) == True
    assert notify('me', 'ephetteplace@cca.edu', ['ANIMA-1000-1 Animation 1'], None, 'followup') == True
    assert notify('me', 'ephetteplace@cca.edu', ['ANIMA-1000-1 Animation 1'], None, 'final') == True
    assert notify('me', 'ephetteplace@cca.edu', ['ANIMA-1000-1 Animation 1'], None, 'summer') == True
